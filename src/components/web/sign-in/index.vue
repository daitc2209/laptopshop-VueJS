			...
			<div class="row">
				...
				<div class="col-md-8 col-12 p-0" id="side2">
					<form class="form-login" method="post" action="@{/j_spring_security_check}">
			            ...
			            <div if="${param.accessDenied}">
			                <div class="alert alert-danger"> You not authorize</div>
			            </div>
						<h3>Login Account</h3>
						<div class="inp">
							<input type="text" name="username" id="username" placeholder="User Name" required> 
							<input autocomplete="" type="password" name="password" id="password" placeholder="Password" required>
						</div>
						...
						<div id="login">
							<a href="/oauth2/authorization/google"><button  type="button"><i class="fa-brands fa-google"></i> &ensp; Sign in by Gmail</button></a>
						</div>
						<div id="login">
